...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {        
        ...
        address ownerToken1Address = ownerOf(_tokenId1);
        address ownerToken2Address = ownerOf(_tokenId2);
        
        _transferFrom(ownerToken1Address, ownerToken2Address, _tokenId1);
        _transferFrom(ownerToken2Address, ownerToken1Address, _tokenId2);
    }
